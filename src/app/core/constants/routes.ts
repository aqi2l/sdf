...
export const SIGIN_BASE_LINK = 'signin';
export const SIGNUP_BASE_LINK = 'signup';
export const RESET_PASSWORD_BASE_LINK = 'reset-password';
export const FORGOT_PASSWORD_BASE_LINK = 'forgot-password';
export const LOGIN = `${AUTH}/${SIGIN_BASE_LINK}`;
export const REGISTER = `${AUTH}/${SIGNUP_BASE_LINK}`;
